...
非编码工作：命令行直接用 cc + deepseek 或者 opencode go 或者 cherrystuidio + key ， mimo 降价也很便宜
...
- 终端工具？
	...
	- 监控用量，swift 编写, 50 mb 内存占用 [steipete/CodexBar: Show usage stats for OpenAI Codex and Claude Code, without having to login.](https://github.com/steipete/codexbar)
...
- 大模型缓存率排名
	- [Cache hit rates of Inference are more meaningful than the headline costs - Dirac Posts](https://dirac.run/posts/cache-hit-rates-agents)
