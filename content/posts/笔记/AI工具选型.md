...
用量小，cursor，codex，antigravity，甚至 cc 走中转站也可以。其中 cc 最贵，codex/antigravity 相对友好

1. **成本 20 美元使用 antigravity**，创建家庭组账号，最多 6 个可以切换。
2. 如果周限额还是有影响，**50 美元**可以 ultra 单个账号
3. 最高档次
...
- github copilot
	...
	- [模型价格](https://docs.github.com/en/copilot/reference/ai-models/supported-models)
- gemini
