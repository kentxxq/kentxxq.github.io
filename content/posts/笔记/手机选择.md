...
2. mbp 2026 有 oled + 挖孔屏
3. ipad 除了 pro, 最近几年的屏幕一直都会是 60 hz
4. 苹果迭代周期 [说出你被苹果背刺最狠的故事，我先来 - V2EX](https://www.v2ex.com/t/1061781)
5. 苹果设备购买建议网站 [MacRumors Buyer's Guide: Know When to Buy iPhone, Mac, iPad](https://buyersguide.macrumors.com/#iPad)
    - 发布多久了, 下一代是不是会马上出来
    - 发布时间
6. 苹果手表联动.
    - 小米手环可以绑在鞋上, 纠正跑姿?
...
12. 服务解锁! [GitHub - VirgilClyne/iRingo: 解锁完整的 Apple功能和集成服务](https://github.com/VirgilClyne/iRingo)
13. 股市 app
14. 播客, 可以通过 url 添加 rssfeed
15. 邮件 app
16. 钱包可以开通香港八达通
17. 备忘录 + 提醒 + 日历
18. safari 浏览器里关闭诈骗拦截
...
21. edge, chrome 在 ios 上内置的 adblock plus 测试
22. apple 账号购买内容迁移
23. 腾讯管家不错, ios 和 mac 都有监控网速 cpu, 电话拦截
24. 邮箱全部转隐私邮箱
25. [求推荐一下 iOS 无广告的浏览器 - V2EX](https://www.v2ex.com/t/978813)
26. iOS 并不支持获取已安装的应用列表，只可以通过配置 LSApplicationQueriesSchemes 然后通过 canOpenURL 逐一探测是否可以打开某个 App 的 Scheme 的方式确定是否安装这个 App  
27. [Site Unreachable](https://www.zhihu.com/question/630670858?utm_psn=1880116154472838282)
28. 浏览器. alook, brave, via, 还是说 safari 配插件. stash 去广告
29. 比特币/数字货币
...
32. gmail 邮箱迁移, [开始使用数据迁移服务 - Google Workspace 管理员帮助](https://support.google.com/a/answer/6003169?hl=zh-Hans),
33. https://v.douyin.com/WTEfaNXBkZ8/ 技巧
34. iPhone 的 icloud 可以和 windows 同步 obsidian
35. shazam 这个 app 的音乐识别体验好, 内置到控制菜单
36. 支持米家，那就支持 Home Assistant，那就支持 Homekit，那就支持 Hey Siri
37. 境外 - 数据隔离
38. HUAWEI FreeClip 耳机口碑很好
39. [从 iOS 提醒事项开始，入门任务管理 - 少数派](https://sspai.com/post/81392)
