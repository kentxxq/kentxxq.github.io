...
- 苹果统一推送. 无解
    ...
    - 微软二次验证可以收到
- 苹果可以信任根证书, 抓包有用. 安卓需要 root, 而 root 后又会被检测
- ipad 在保险业有独特的优势
    - 便携
    - 清晰
    - 可以签字
...
15. 写个文章, 远程抹掉数据 [在 iCloud.com 上的“查找设备”中抹掉设备 - 官方 Apple 支持 (中国)](https://support.apple.com/zh-cn/guide/icloud/mmfc0ef36f/icloud)
16. 问题
    - bitwarden 无法使用主机域 [Host-based Auto-fill iOS is odd… : r/Bitwarden](https://www.reddit.com/r/Bitwarden/comments/177d0d4/hostbased_autofill_ios_is_odd/)
