...
直接套模板  
- [vben](https://jacobhsu.github.io/vue-vben-admin-docs/guide/introduction.html) 太重了,模板不更新. 也是tsx  
- [pure-admin](https://yiming_chang.gitee.io/pure-admin-doc/pages/start/) 前 element 团队员工  
    - 模板永远同步  
- [tdesign](https://tdesign.tencent.com/starter/docs/vue-next/router-menu) vite更新不及时.   
