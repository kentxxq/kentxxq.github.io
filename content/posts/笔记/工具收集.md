...
- 好看的终端输出 [GitHub - unjs/consola: 🐨 Elegant Console Logger for Node.js and Browser](https://github.com/unjs/consola)
...
- 客户端
    ...
    - finalshell
    - mobaXterm
    - [SecureCRT for iOS](https://www.vandyke.com/products/securecrt/securecrt_ios.html)
    - warp - ai
    - iterm 2 -ai
