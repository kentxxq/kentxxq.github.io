...
- 一个 go 写的工具，支持 ftp，sftp ，webdav 等等一些协议。而存储可以用 s3，或者本地目录。 [GitHub - drakkan/sftpgo: Fully featured and highly configurable SFTP server with optional HTTP/S, FTP/S and WebDAV support - S3, Google Cloud Storage, Azure Blob](https://github.com/drakkan/sftpgo)
...
- 类似 IFTTT，但是对开发者更友好 [GitHub - PipedreamHQ/pipedream: Connect APIs, remarkably fast. Free for developers.](https://github.com/PipedreamHQ/pipedream?tab=readme-ov-file)
