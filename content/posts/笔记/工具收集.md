...
- [[fluent-reader](https://github.com/yang991178/fluent-reader)](https://github.com/yang991178/fluent-reader) 桌面 + [yang991178/fluent-reader-lite](https://github.com/yang991178/fluent-reader-lite) 移动端
...
- 苹果系专用 [Ranchero-Software/NetNewsWire: RSS reader for macOS and iOS. (github.com)](https://github.com/Ranchero-Software/NetNewsWire)
- [万物皆可RSSHub](https://docs.rsshub.app/routes/bbs#v2ex-zui-re-%2F-zui-xin-zhu-ti)
- 桌面端 [Releases · hello-efficiency-inc/raven-reader (github.com)](https://github.com/hello-efficiency-inc/raven-reader)
- 自部署 web 端 [commafeed](https://github.com/Athou/commafeed), [FreshRSS](https://github.com/FreshRSS/FreshRSS), [selfoss – the open source web based rss reader and multi source mashup aggregator (aditu.de)](https://selfoss.aditu.de/)
- 主流收费 Feedly、Inoreader 和 NewsBlur, [reeder苹果收费](https://reederapp.com/)
- 可参考教程 [重新捡起RSS：RSSHub + FreshRSS 建立信息流 (l3zc.com)](https://l3zc.com/2023/07/rsshub-freshrss-information-flow/)
