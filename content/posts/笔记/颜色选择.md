...
- 主色，警告色之类的使用 UI 库颜色
	- wot-ui `#4D80F0`
- 层次感通过阴影 `shadow-lg` ，边框 `border` ，圆角 `rounded-lg`
- 浅色
	- 背景色 `bg-[#F6F7F8]`
	- 卡片 `bg-white` 同 `#000000`
	- 1 级文字 - 标题 `text-black` 或 `text-[#1a1a1a]`
	- 2 级文字 - 正文 `text-[#333333]`
	- 辅助文字 `text-[#999999]`
	- 分割线 `border-[#e5e5e5]`
- 深色
	- 背景色 `bg-black` 同 `#ffffff` 或 `bg-[#121212]`
	- 卡片 `bg-[#262626]`
	- 1 级文字 - 标题 `text-white`
	- 2 级文字 - 正文 `text-[#e0e0e0]`
	- 辅助文字 `text-[#6E6E6E]`
	- 分割线 `border-[#2c2c2c]`

### 配置使用

#### [[tailwindcss手册|tailwindcss]]
...
- [颜色选择参考资料](https://uxplanet.org/8-tips-for-dark-theme-design-8dfc2f8f7ab6)
...
- 谷歌颜色表 [Color - Style - Material Design](https://m1.material.io/style/color.html?utm_source=chatgpt.com#color-themes)
