...
- 通用
	...
	- slidev 用 md 做 ppt https://marketplace.visualstudio.com/items?itemName=antfu.slidev
		- 可以在 obsidian 上用 [MSzturc/obsidian-advanced-slides: Create markdown-based reveal.js presentations in Obsidian](https://github.com/MSzturc/obsidian-advanced-slides)
